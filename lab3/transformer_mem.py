'''
Script to compute memory required by a transformer model for training/inference
from: 

https://gist.github.com/Quentin-Anthony/f43939791a7ceb0b01a4937308317be5#file-transformer_mem-py
